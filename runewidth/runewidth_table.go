...
var combiningInit sync.Once
var combiningData table

func combining() table {
	combiningInit.Do(func() {
		combiningData = table{
...
var doublewidthInit sync.Once
var doublewidthData table

func doublewidth() table {
	doublewidthInit.Do(func() {
		doublewidthData = table{
	...
	return doublewidthData
}

var ambiguosInit sync.Once
var ambiguousData table

func ambiguous() table {
	ambiguosInit.Do(func() {
		ambiguousData = table{
...
var notassignedInit sync.Once
var notassignedData table

func notassigned() table {
	notassignedInit.Do(func() {
		notassignedData = table{
			{0x27E6, 0x27ED}, {0x2985, 0x2986},
		}
	})
	return notassignedData
}

var neutralInit sync.Once
var neutralData table
