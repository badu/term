...
type cancellationPixel struct{ *image.Point }
...
func (s *cancellationPixel) Position() *image.Point        { return s.Point }
...
func newCancellationPixel() term.PixelGetter {
	return &cancellationPixel{Point: &image.Point{X: -1, Y: -1}}
}
